...
template-init-check: ## Check 208 canonical projections and build/test twenty-six runtime representatives (13-26 also run their retained database suites; Docker)
...
template-init-projections: ## Check the 208 canonical projections alone, without Cargo
