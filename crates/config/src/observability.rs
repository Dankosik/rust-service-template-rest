...
pub struct MetricsConfig {
    /// Private Prometheus diagnostics listener. It binds every interface by
    /// default because the scraper runs in another pod; deployment network
    /// policy must keep it private. Empty disables HTTP exposition.
    pub addr: String,
}
