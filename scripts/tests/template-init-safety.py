...
def legacy_profile_inventory_bytes(source: Path) -> bytes:
    ...
    postgres_markers = legacy["postgres"]["markers"]
    postgres_markers.remove({"path": "crates/infra-http/Cargo.toml", "id": "http-postgres-dependency"})
    postgres_markers.remove({"path": "crates/infra-http/src/lib.rs", "id": "infra-http-postgres-tx"})
